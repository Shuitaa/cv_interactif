...
<body>
    <header class="header">
        ...
        <nav class="nav-icon">
            <a href="../index.php"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22">
                    <path id="home"
                        d="M49.064,70.8h6.878V65.726a3.414,3.414,0,0,1,.948-2.372,3.126,3.126,0,0,1,4.557,0,3.414,3.414,0,0,1,.948,2.372V70.8h6.878V60.974L58.985,50.836,49.064,60.968V70.8Zm7.325.929H48.617a.454.454,0,0,1-.447-.465V60.776h0a.471.471,0,0,1,.133-.332L58.663,49.867a.434.434,0,0,1,.627-.011l10.717,10.56a.469.469,0,0,1,.163.36V71.263a.454.454,0,0,1-.447.465H61.951a.454.454,0,0,1-.447-.465V65.726a2.468,2.468,0,0,0-.686-1.714,2.259,2.259,0,0,0-3.3,0,2.47,2.47,0,0,0-.686,1.714v5.537A.456.456,0,0,1,56.389,71.727Z"
                        transform="translate(-48.17 -49.727)" fill="#011627" />
                </svg>
            </a>

            <a href="../contact/contact.php"><svg xmlns="http://www.w3.org/2000/svg" width="29.603" height="23.5"
                    viewBox="0 0 29.603 23.5">
                    <g id="Icon_feather-mail" data-name="Icon feather-mail" transform="translate(-1.949 -5.25)">
                        <path id="Tracé_1" data-name="Tracé 1"
                            d="M5.75,6h22A2.758,2.758,0,0,1,30.5,8.75v16.5A2.758,2.758,0,0,1,27.75,28h-22A2.758,2.758,0,0,1,3,25.25V8.75A2.758,2.758,0,0,1,5.75,6Z"
                            stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                        <g id="Groupe_12" data-name="Groupe 12">
                            <path id="Tracé_2" data-name="Tracé 2" d="M30.5,9,16.75,19.5,3,9" stroke="#fff"
                                stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                        </g>
                    </g>
                </svg></a>
            <a href="https://www.linkedin.com/in/pierre-averty-996ab5195/"><svg xmlns="http://www.w3.org/2000/svg"
                    width="23.5" height="23.5" viewBox="0 0 23.5 23.5">
                    <path id="Icon_awesome-linkedin-in" data-name="Icon awesome-linkedin-in"
                        ...
                        transform="translate(0.75 0.749)" fill="none" stroke="#000" stroke-width="1.5" /></svg></a>
            <a href="https://github.com/Shuitaa"><svg xmlns="http://www.w3.org/2000/svg" width="22.062" height="23.525"
                    viewBox="0 0 22.062 23.525">
                    <path id="Icon_feather-github" data-name="Icon feather-github"
                        ...
                        transform="translate(-2.09 -0.685)" fill="none" stroke="#000" stroke-linecap="round"
                        stroke-linejoin="round" stroke-width="1.5" /></svg></a>
